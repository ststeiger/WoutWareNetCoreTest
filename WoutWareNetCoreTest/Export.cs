...
namespace DwgToSvgConverter
{
    ...
    public class Export
    {
        ...
        public static void ExportToSvg(WW.Cad.Model.DxfModel model, string path)
        {
            ...
            WW.Drawing.Printing.PaperSize paperSize = WW.Cad.Drawing.PaperSizes.GetPaperSize(WW.Drawing.Printing.PaperKind.A4);
            ...
            */
            ...
            using (System.IO.StringWriter stringWriter = new System.IO.StringWriter(sb))
            {
                ...
                using (System.Xml.XmlTextWriter xmlWriter = new System.Xml.XmlTextWriter(stringWriter))
                {
                    ...
                    System.IO.File.WriteAllText(@"testfile_OG14.svg", strSVG, System.Text.Encoding.UTF8);
